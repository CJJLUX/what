...
#define GPIO_D                        (*(volatile unsigned int *)(BASE_ADDRESS + 0xD000))      

#define GPIODOUT                      (*(volatile unsigned int *)(GPIO_D + 0xD000)) 
#define GPIODOUTENB                   (*(volatile unsigned int *)(GPIO_D + 0xD004)) 
#define GPIODALTFN0                   (*(volatile unsigned int *)(GPIO_D + 0xD020)) 
#define GPIODALTFN1                   (*(volatile unsigned int *)(GPIO_D + 0xD024)) 
#define GPIOD_PULLENB                 (*(volatile unsigned int *)(GPIO_D + 0xD060))
#define GPIOD_PULLENB_DISABLE_DEFAULT (*(volatile unsigned int *)(GPIO_D + 0xD064))
...
//UART0
#define UART_BaseAddress        0xC00A0000
